          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:text-center">
              ...
              <p className="mt-4 text-2xl pt-1 font-extrabold tracking-tight text-text-color sm:text-4xl flex justify-center">
                ...
                <p className="animate-pulse p-0.5 pt-1 align-middle text-2xl font-bold text-white"></p>
                <p className="text-2xl font-bold pt-1 text-stone-300 ">&lt;/<span className="text-2xl pt-1 font-bold text-indigo-600">div</span>&gt;</p>
              </p>
